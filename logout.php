...
<head>
    ...
    <title>Cerrando Sesión - Plataforma Escrow</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="max-w-md w-full bg-white p-8 rounded-2xl shadow-lg text-center">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Has cerrado sesión correctamente.</h1>
        <p class="text-gray-600 mt-2">Serás redirigido a la página de inicio en unos segundos.</p>
        <div class="mt-6">
            <a href="index.php" class="font-medium text-indigo-600 hover:underline">Ir a la página de inicio ahora</a>
        </div>
    </div>
</body>
</html>
